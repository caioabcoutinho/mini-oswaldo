...
ActiveRecord::Schema[8.0].define(version: 2025_10_22_173102) do
  ...
  create_table "appointment_items", force: :cascade do |t|
    ...
    t.index ["product_id"], name: "index_appointment_items_on_product_id"
  end
  ...
  create_table "appointments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["hub_id"], name: "index_appointments_on_hub_id"
  ...
  create_table "stock_items", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["hub_id"], name: "index_stock_items_on_hub_id"
  ...
  add_foreign_key "appointment_items", "products"
  add_foreign_key "appointments", "hubs"
